...
public class FarmReport {
    ...
    // this method loads all data from the database
    ...
    public ArrayList<String[]> getCattleList()       { return cattleList;       }
    public ArrayList<String[]> getSheepList()        { return sheepList;        }
    public ArrayList<String[]> getPoultryList()      { return poultryList;      }
    public ArrayList<String[]> getStockList()        { return stockList;        }
    public ArrayList<String[]> getHealthRecordList() { return healthRecordList; }
    ...
    public int getTotalHealthy()                     { return totalHealthy;     }
